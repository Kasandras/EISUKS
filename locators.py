...
class DocumentsLocators:
    ...
    class Documents(object):
        type_document = (By.XPATH, "//div[contains(@id, 's2id')]")
        name_document = (By.XPATH, "//input[@ng-model='document.Name']")
    ...
    class Education(object):
        ...
        class Main(object):
            ...
            start_date_education = (By.XPATH, "//input[@name='startDate']")
            end_date_education = (By.XPATH, "//input[@name='endDate']")
...
class VacancyCreateLocators(object):
    ...
    job_type_other_text = (By.XPATH, "//input[@name='jobTypeOtherText']")
    ...
    class PostIsCompetition(object):
        ...
        business_trip = (By.XPATH, "(//div[contains(@id, 's2id')])[12]")
        work_schedule = (By.XPATH, "(//div[contains(@id, 's2id')])[13]")
        work_day = (By.XPATH, "(//div[contains(@id, 's2id')])[14]")
        work_contract = (By.XPATH, "(//div[contains(@id, 's2id')])[15]")
        education_level = (By.XPATH, "(//div[contains(@id, 's2id')])[16]")
        government_experience = (By.XPATH, "(//div[contains(@id, 's2id')])[17]")
        professional_experience = (By.XPATH, "(//div[contains(@id, 's2id')])[18]")
        test = (By.XPATH, "(//div[contains(@id, 's2id')])[19]")
        document_type = (By.XPATH, "(//div[contains(@id, 's2id')])[21]")
        organization_address = (By.XPATH, "(//div[contains(@id, 's2id')])[20]")
    ...
    class ReservePost(object):
        ...
        work_schedule = (By.XPATH, "(//div[contains(@id, 's2id')])[14]")
        work_contract = (By.XPATH, "(//div[contains(@id, 's2id')])[15]")
        education_level = (By.XPATH, "(//div[contains(@id, 's2id')])[16]")
        government_experience = (By.XPATH, "(//div[contains(@id, 's2id')])[17]")
        professional_experience = (By.XPATH, "(//div[contains(@id, 's2id')])[18]")
    ...
    class VacantStudy(object):
        ...
        job_type = (By.XPATH, "(//div[contains(@id, 's2id')])[6]")
...
class ReserveBasesPrepareLocators(object):
    ...
    save = (By.XPATH, "//input[@ng-click='saveEdit()']")
    ...
    education_level = (By.XPATH, "(//div[contains(@id, 's2id')])[1]")
    education_kinds = (By.XPATH, "(//div[contains(@id, 's2id')])[1]")
    education_forms = (By.XPATH, "(//div[contains(@id, 's2id')])[2]")
    place = (By.XPATH, "//input[@data-ng-model='editmodel.place']")
    temp_institution = (By.XPATH, "(//div[contains(@id, 's2id')])[3]")
    start_date = (By.XPATH, "//input[@id='startDate']")
    end_date = (By.XPATH, "//input[@id='endDate']")
    faculty = (By.XPATH, "//input[@data-ng-model='editmodel.faculty']")
    education_doc_number = (By.XPATH, "//input[@data-ng-model='editmodel.educationDocNumber']")
    speciality = (By.XPATH, "(//div[contains(@id, 's2id')])[4]")
    qualification = (By.XPATH, "(//div[contains(@id, 's2id')])[5]")
    specialization = (By.XPATH, "//input[@data-ng-model='editmodel.specialization']")
    begin_date = (By.XPATH, "//input[@id='beginDate']")
    stop_date = (By.XPATH, "(//input[@type='text'])[2]")
    organization_work = (By.XPATH, "//input[@name='organization']")
    address_organization = (By.XPATH, "//input[@name='addressOrganization']")
    structural_division = (By.XPATH, "//input[@id='structuralDivision']")
    post = (By.XPATH, "//input[@name='post']")
    post_levels = (By.XPATH, "(//div[contains(@id, 's2id')])[1]")
    employees_numbers = (By.XPATH, "(//div[contains(@id, 's2id')])[2]")
    profile = (By.XPATH, "(//div[contains(@id, 's2id')])[3]")
    professional_activity_area = (By.XPATH, "(//div[contains(@id, 's2id')])[4]")
    responsibilities = (By.XPATH, "//input[@id='responsibilities']")
    job_types = (By.XPATH, "(//div[contains(@id, 's2id')])[1]")
    expectations = (By.XPATH, "//textarea[@ng-model='model.expectations']")
    organization_sub_type = (By.XPATH, "(//div[contains(@id, 's2id')])[2]")
    organization = (By.XPATH, "(//div[contains(@id, 's2id')])[3]")
    organization_other = (By.XPATH, "//input[@id='organizationOther']")
    salary_from = (By.XPATH, "//input[@data-ng-model='model.salaryFrom']")
    salary_to = (By.XPATH, "//input[@data-ng-model='model.salaryTo']")
    computer_skills = (By.XPATH, "//textarea[@ng-model='model.computerSkills']")
    publications = (By.XPATH, "//textarea[@ng-model='model.publications']")
    recommendations = (By.XPATH, "//textarea[@ng-model='model.recommendations']")
